...
import { isUserAuthorized, useIsSticky } from "../../lib/utils";
...
function Project() {
    ...
    console.log("projectData", projectData.data.project);
    ...
    if (!isUserAuthorized(user) && !projectData.data.project.public) {
        return (
            <>
                <main className="pt-10 min-h-[calc(100vh_-_126px)] flex flex-col items-center">
