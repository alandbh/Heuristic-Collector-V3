...
function Toggle({ onChange, selected, disable = false }) {
    ...
    return (
        <>
            <div className="h-6 overflow-x-scroll w-full lg:overflow-x-visible  rounded-full flex items-center switch-scroll">
                <div
                ...
                >
                    ...
                    >
                        <label
                            style={{ flex: "0 0 44px" }}
                            className="flex w-[44px] h-[44px] items-center justify-center cursor-pointer"
                        >
                            <input
                                type="checkbox"
                                className="sr-only"
