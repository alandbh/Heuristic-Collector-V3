...
export const processChange = async (
    ...
    return doMutate(client, variables, gqlString, isCreate);
};
...
export async function doMutate(client, variables, gqlString, isCreate) {
    ...
    if (data) {
        ...
        const newData = await doPublic(client, newId, isCreate);
...
export async function doPublic(client, newId, isCreate) {
    ...
    console.log("mudando para publico", data);
...
export const missingLogoUrl =
    "https://sa-east-1.graphassets.com/AWG2oyRa0T4GOOaiwmElGz/cmhuz4xx9053707lu3mia7a8o";
